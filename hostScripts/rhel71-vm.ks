...
url --url="http://download.devel.redhat.com/released/RHEL-7/7.1-RC-2/Server/x86_64/os/"
...
%post
wget -O /etc/yum.repos.d/rhel71.repo http://perf1.perf.lab.eng.bos.redhat.com/atheurer/repo-files/rhel71.repo
wget -O /etc/yum.repos.d/rhel71z.repo http://perf1.perf.lab.eng.bos.redhat.com/atheurer/repo-files/rhel71z.repo
yum update -y
