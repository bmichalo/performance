...
#url --url="baseurl=http://download.devel.redhat.com/released/RHEL-7/7.1/Server/x86_64/os/"
url --url="http://download.devel.redhat.com/released/RHEL-7/7.2/Server/x86_64/os/"
...
%post
wget -O /etc/yum.repos.d/rhel72.repo http://perf1.perf.lab.eng.bos.redhat.com/krister/repo-files/rhel72.repo
wget -O /etc/yum.repos.d/rhel72z.repo http://perf1.perf.lab.eng.bos.redhat.com/krister/repo-files/rhel72z.repo
yum update -y
wget -O /etc/yum.repos.d/pbench-copr.repo https://copr.fedoraproject.org/coprs/ndokos/pbench/repo/epel-7/ndokos-pbench-epel-7.repo
wget -O /etc/yum.repos.d/configtools-copr.repo https://copr.fedoraproject.org/coprs/ndokos/configtools/repo/epel-7/ndokos-configtools-epel-7.repo
wget -O /etc/yum.repos.d/pbench.repo http://pbench.perf.lab.eng.bos.redhat.com/repo/yum.repos.d/pbench.repo
wget -O /etc/yum.repos.d/pbench-test.repo http://pbench.perf.lab.eng.bos.redhat.com/repo/yum.repos.d/pbench-test.repo
yum install -y pbench-agent-internal
mkdir /root/.ssh
chmod 700 /root/.ssh
